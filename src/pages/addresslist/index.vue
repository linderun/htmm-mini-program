<template>
	<div>
		<div style="background: #f6f6f6;">
			<div class="my_adres">
				<div v-show="addrlist.length == 0" class="nodata"><image src="/static/images/nodata.jpg" mode="aspectFit" /></div>
	...
	methods: {
		...
		setdefault(state, index) {
			if (state != '1') {
				...
				api.editAddress({ formData: {is_default:'1'} },that.addrlist[index].id).then(function(da) {
					var da = da.param;
					if (da.code == 200) {
						wx.showToast({
							title: '设置默认地址成功',
